...
const Projects = () => {
  return (
    <div className="bg-white mt-2 py-12">
      <div className="mb-8 px-4 mt-16">
        <h3 className="text-black text-4xl font-semibold text-center">
          Our Successful Projects
        </h3>
        <p className="text-center text-gray-800 text-sm mt-2 max-w-lg mx-auto">
          Discover the innovative solutions we've delivered to our clients,
    ...
    >
      {list.map((t) => {
        return (
          <div
            key={t.id}
            className="shrink-0 w-[500px] h-[300px] grid rounded-lg overflow-hidden relative"
          >
            <div className="bg-slate-900 text-slate-50 p-4"></div>
